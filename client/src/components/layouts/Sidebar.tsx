	...
	return (
		<aside className="w-60 shrink-0 bg-[#0a1422] border-r border-[#1e293b] flex flex-col py-7 overflow-y-auto">
			...
			<div className="flex-1 px-3">
				<span className="text-[9px] tracking-[0.18em] text-slate-500 px-3 block mb-2">ACCOUNTS</span>
			...
			<div className="px-3 pt-5 border-t border-[#1e293b]">
				<button
					onClick={logout}
					className="flex justify-center w-full px-3 py-2 border bg-red-800 rounded-lg text-[14px] text-white-300 tracking-widest 
							 hover:text-red-200 transition-colors text-left hover:cursor-pointer active:text-red-400"
				>
					Sign Out
				</button>
			</div>
