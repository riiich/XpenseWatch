...
export function AddTransactionForm({
    ...
    const { selectedAccId, selectedCategoryId, getAccounts, getTransactions } =
        useApp();
    ...
    const set = <K extends keyof typeof manualForm>(
        key: K,
        val: (typeof manualForm)[K],
    ...
    const handleManualSubmit = async () => {
		...
		console.log("category: ", manualForm);
    ...
    const handleFileUpload = async () => {
        ...
        setUploading(false);
        alert(
            "File uploaded! Your backend will parse and return transactions.",
        );
                ...
                <div className="grid grid-cols-2 gap-3.5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                set("transactionDate", e.target.value)
                            }
                        />
                    </div>
