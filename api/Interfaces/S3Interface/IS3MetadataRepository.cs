...
public interface IS3MetadataRepository
{
    ...
    Task<S3Metadata?> GetReceiptByTransactionIdAsync(int transactionId, string userId);
    // Task<S3Metadata?> GetStatementByAccountIdAsync(int accountId, string userId);
